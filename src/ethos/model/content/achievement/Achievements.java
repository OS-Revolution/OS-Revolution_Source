...
public class Achievements {
    ...
    public enum Achievement {
    	...
    	//Added achievements:
    	//Cow_Killer, 
        Cow_Killer(0, AchievementTier.TIER_1, AchievementType.SLAY_COWS, null, "Kill 100 Cows", 100, 1, new GameItem(995, 50000), new GameItem(405)),
        Crab_Killer(1, AchievementTier.TIER_1, AchievementType.SLAY_ROCK_CRABS, null, "Kill 100 Rock Crabs", 100, 1, new GameItem(995, 55000), new GameItem(405)),
        Slaughter_House(3, AchievementTier.TIER_1, AchievementType.SLAY_CHICKENS, null, "Kill 150 Chickens", 150, 1, new GameItem(995, 60000), new GameItem(405), new GameItem(1945, 100)),
        CHAOS_DRUIDS(4, AchievementTier.TIER_1, AchievementType.SLAY_CHAOS_DRUIDS, null, "Kill 200 Chaos Druids", 200, 1, new GameItem(995, 70000), new GameItem(405)),
        Bby_Dragon_Hunter_I(5, AchievementTier.TIER_1, AchievementType.SLAY_BABY_DRAGONS, null, "Kill 50 Baby Dragons", 50, 1, new GameItem(995, 50000), new GameItem(535, 100), new GameItem(405)),
        DRAGON_SLAYER_I(6, AchievementTier.TIER_1, AchievementType.SLAY_DRAGONS, null, "Kill 25 Dragons", 25, 1, new GameItem(995, 50000), new GameItem(537, 50), new GameItem(405)),
        PvMer_I(7, AchievementTier.TIER_1, AchievementType.SLAY_ANY_NPCS, null, "Kill 1000 Npcs", 1000, 1, new GameItem(995, 50000), new GameItem(405)),
        Boss_Hunter_I(8, AchievementTier.TIER_1, AchievementType.SLAY_BOSSES, null, "Kill 100 Bosses", 100, 1, new GameItem(995, 50000), new GameItem(11937, 50), new GameItem(405)),
        Fishing_Task_I(9, AchievementTier.TIER_1, AchievementType.FISH, null, "Catch 1000 Fish", 1000, 1, new GameItem(995, 50000)),
        Cooking_Task_I(10, AchievementTier.TIER_1, AchievementType.COOK, null, "Cook 1000 Fish", 1000, 1, new GameItem(995, 50000), new GameItem(3145, 50)),
        Mining_Task_I(11, AchievementTier.TIER_1, AchievementType.MINE, null, "Mine 1000 Rocks", 1000, 1, new GameItem(995, 50000), new GameItem(12013), new GameItem(12016)),
        Smithing_Task_I(12, AchievementTier.TIER_1, AchievementType.SMITH, null, "Smith 1000 Bars", 1000, 1, new GameItem(995, 50000), new GameItem(2360, 300)),
        Farming_Task_I(13, AchievementTier.TIER_1, AchievementType.FARM, null, "Pick Herbs 100 Times", 100, 1, new GameItem(995, 50000), new GameItem(208, 150), new GameItem(13646), new GameItem(13644)),
        Herblore_Task_I(14, AchievementTier.TIER_1, AchievementType.HERB, null, "Mix 500 Potions", 500, 1, new GameItem(995, 50000), new GameItem(100, 50)),
        Woodcutting_Task_I(15, AchievementTier.TIER_1, AchievementType.WOODCUT, null, "Cut 500 Trees", 500, 1, new GameItem(995, 50000), new GameItem(10933), new GameItem(10941)),
        Fletching_Task_I(16, AchievementTier.TIER_1, AchievementType.FLETCH, null, "Fletch 1000 Logs", 1000, 1, new GameItem(995, 50000), new GameItem(63, 300)),
        Firemaking_Task_I(17, AchievementTier.TIER_1, AchievementType.FIRE, null, "Light 500 Logs", 500, 1, new GameItem(995, 50000), new GameItem(20710)),
        Theiving_Task_I(18, AchievementTier.TIER_1, AchievementType.THIEV, null, "Steal 500 Times", 500, 1, new GameItem(995, 50000), new GameItem(5557), new GameItem(5556)),
        Agility_Task_I(19, AchievementTier.TIER_1, AchievementType.AGIL, null, "Complete 100 Course Laps", 100, 1, new GameItem(995, 50000), new GameItem(11849, 15)),
        Slayer_Task_I(20, AchievementTier.TIER_1, AchievementType.SLAY, null, "Complete 50 Slayer Tasks", 50, 1, new GameItem(995, 50000), new GameItem(405)),
        CKey_Task(21, AchievementTier.TIER_1, AchievementType.LOOT_CRYSTAL_CHEST, null, "Loot Crystal Chest 50 Times", 50, 1, new GameItem(995, 50000), new GameItem(990, 5)),
        Pc_Task(22, AchievementTier.TIER_1, AchievementType.PEST_CONTROL_ROUNDS, null, "Complete Pest Control 50 Times", 50, 1, new GameItem(995, 50000), new GameItem(405), new GameItem(8841)),
        Jad_Task(23, AchievementTier.TIER_1, AchievementType.FIGHT_CAVES_ROUNDS, null, "Complete Fightcaves 3 Times", 3, 1, new GameItem(995, 50000), new GameItem(405), new GameItem(6570)),
        Barrows_Task_I(24, AchievementTier.TIER_1, AchievementType.BARROWS_RUNS, null, "Loot 100 Barrows Chests", 100, 1, new GameItem(995, 50000), new GameItem(405)),
        ClueScroll_Task(25, AchievementTier.TIER_1, AchievementType.CLUES, null, "Loot 50 Clue Caskets", 50, 1, new GameItem(995, 50000)),
        /**
