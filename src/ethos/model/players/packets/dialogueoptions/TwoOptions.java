            ...
            case 2:
                c.getDH().sendDialogueSequence(
                        new DialogSequence.DialogSequenceBuilder(c)
                                .addNpcChat("Radimus Erkle", 3953,
                                        "Splendid! Your contribution is appreciated hero."
                                )
                                .addDialogueAction(new Dialog() {
                                    @Override
                                    public void onSend() {
                                        c.getItems().deleteItem2(995, HallOfHeroesUtils.STANDARD_CAPE_COST);
                                        c.getItems().addItem(HallOfHeroesUtils.getCapeId(c.getAttributes().getInteractingWithNodeId(), c), 1);
                                        c.getItems().addItem(HallOfHeroesUtils.getHoodId(c.getAttributes().getInteractingWithNodeId(), c), 1);
                                    }
                                })
                                .addItemStatement(HallOfHeroesUtils.getCapeId(c.getAttributes().getInteractingWithNodeId(), c), "You Purchased the Cape of Accomplishment")
                                .build()
                );
                break;
            case 3:
                if (c.getItems().playerHasItem(995, FirstClickEstateAgentAction.FEE)) {
                    c.getDH().sendDialogueSequence(
                            new DialogSequence.DialogSequenceBuilder(c)
                                    .setActionLocked(true)
                                    .setMovementRestricted(true)
                                    .addNpcChat("Estate Agent", 5419,
                                            "Great! It's yours. Allow me to give you a tour"
                                    )
                                    .addDialogueAction(new Dialog() {
                                        @Override
                                        public void onSend() {
                                            c.getContext().getPlayerSaveData().setHomeUnlocked(true);
                                            c.getItems().deleteItem2(995, FirstClickEstateAgentAction.FEE);
                                    ...
                                    .addStatement("You've unlocked the house")
                                    .build()
                    );
                } else {
                    c.getDH().sendDialogueSequence(
    ...
    public static void handleOption2(Player c) {
        ...
        switch (c.dialogueAction) {
            ...
            case 2:
                c.getDH().sendDialogueSequence(
                        new DialogSequence.DialogSequenceBuilder(c)
                                .addNpcChat("Radimus Erkle", HallOfHeroesUtils.GUILD_LEADER_ID,
                                        "Suit yourself.")
                                .build()
                );
                break;
