...
public class Herblore {
	...
	public void clean(int itemId) {
		...
		herb.ifPresent(h -> {
			...
			player.getPA().addSkillXP((int) (h.getExperience() * (player.getMode().getType().equals(ModeType.OSRS) ? 1 : Config.HERBLORE_EXPERIENCE * player.prestige())), Skill.HERBLORE.getId(), true);
		...
		potion.ifPresent(p -> {
			...
			CycleEventHandler.getSingleton().addEvent(player, new CycleEvent() {
				...
				public void execute(CycleEventContainer container) {
					...
					player.getPA().addSkillXP((int) (p.getExperience() * (player.getMode().getType().equals(ModeType.OSRS) ? 1 : Config.HERBLORE_EXPERIENCE * player.prestige())), Skill.HERBLORE.getId(), true);
