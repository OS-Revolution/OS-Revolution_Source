...
public class DialogueHandler {
	 ...
	 */
	public static final int HAPPY = 588, CALM = 589, CALM_CONTINUED = 590, CONTENT = 591, EVIL = 592, EVIL_CONTINUED = 593,
	...
	public void sendDialogues(int dialogueId) {
		switch (dialogueId) {
			case 0:
	...
	public void sendDialogueSequence(DialogSequence sequence) {
		c.getAttributes().setActiveDialogSequence(sequence);
		sequence.start(1);
	}

	public void sendDialogueSequence(int startingFrame) {
		c.getAttributes().getActiveDialogSequence().start(startingFrame);
	}
...
//
//		case 9042:
//			sendNpcChat1("Touch�", 6637, "Kalphite Princess");
//			c.nextChat = -1;
//			break;
//
//		case 9050:
...
//
//		case 9049:
//			sendNpcChat1("Touch�", 6638, "Kalphite Princess");
//			c.nextChat = -1;
//			break;
//
//		case 9051:
...
//
//			case 100000:
//				sendPlayerChat1("I wonder what it does?",CALM_CONTINUED);
//				break;
//
//
//		case 700:
...
//			break;
	...
	public void sendNpcChat(String name, int id,String... messages) {
		switch (messages.length) {
			case 1:
				sendNpcChat1(messages[0], id, name);
				break;

			case 2:
				sendNpcChat2(messages[0], messages[1], id, name);
				break;

			case 3:
				sendNpcChat3(messages[0], messages[1], messages[2], id, name);
				break;

			case 4:
				sendNpcChat4(messages[0], messages[1], messages[2], messages[3],id, name);
				break;
		}
	}

	public void sendPlayerChat(int emotionId,String... messages) {
		String name = WordUtils.capitalize(c.playerName);

		switch (messages.length) {
			case 1:
				sendPlayerChat1(messages[0], emotionId);
				break;

			case 2:
				sendPlayerChat2(messages[0], messages[1], emotionId);
				break;

			case 3:
				sendPlayerChat3(messages[0], messages[1], messages[2],emotionId);
				break;

			case 4:
				sendPlayerChat4(messages[0], messages[1], messages[2], messages[3],emotionId);
				break;
		}
	}

//	public void sendOptions(String... messages) {
//		switch (messages.length) {
//			case 1:
//				sendOption(messages[0]);
//				break;
//
//			case 2:
//				sendOption2(messages[0], messages[1]);
//				break;
//
//			case 3:
//				sendOption3(messages[0], messages[1], messages[2]);
//				break;
//
//			case 4:
//				sendOption4(messages[0], messages[1], messages[2], messages[3]);
//				break;
//		}
//	}
	...
	private void sendPlayerChat2(String s, String s1, int emoteid) {
	...
	private void sendPlayerChat3(String s, String s1, String s2, int emoteid) {
		c.getPA().sendFrame200(980, emoteid);
	...
	public void sendPlayerChat4(String s, String s1, String s2, String s3, int emoteid) {
		c.getPA().sendFrame200(987, emoteid);
