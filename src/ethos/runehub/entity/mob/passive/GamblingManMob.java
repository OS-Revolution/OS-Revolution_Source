...
public class GamblingManMob extends PassiveMob {

    private static GamblingManMob instance = null;

    public static GamblingManMob getInstance(int index) {
        if (instance == null)
            instance = new GamblingManMob(index);
        return instance;
    }
    ...
    private GamblingManMob(int npcIndex) {
        super(5055);
