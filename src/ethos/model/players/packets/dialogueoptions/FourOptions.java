...
public class FourOptions {
    ...
    public static void handleOption1(Player c) {
        ...
        switch (c.dialogueAction) {
            case 1: // sailing explanation
                c.getDH().sendDialogueSequence(new DialogSequence.DialogSequenceBuilder(c)
                        .addNpcChat("Port Master", 6999,
                                "Certainly, Sailing begins with obtaining a ship",
                                "any ship will do, but the better the ship",
                                "the better your voyages will go.")
                        .addNpcChat("Port Master", 6999,
                                "Once you've got your ship you will need to hire a crew.",
                                "Your crew will be making voyages for you, so that you",
                                "may focus on managing the port."
                        )
                        .addNpcChat("Port Master", 6999,
                                "Your port has facilities to support up to",
                                "3 ships and 3 separate crews."
                        )
                        .addNpcChat("Port Master", 6999,
                                "Once you've got your ship and crew you may",
                                "speak with me to see what voyages are available",
                                "and which voyages to send your ships on."
                        )
                        .addNpcChat("Port Master", 6999,
                                "As you complete more voyages and explore more",
                                "of Wushanko, you will discover new regions to send",
                                "your ships. "
                        )
                        .addNpcChat("Port Master", 6999,
                                "There are many voyages each with their own unique",
                                "difficulties. Better ships, and more experience will",
                                "increase your chances of success. Voyages that fail can",
                                "sometimes be... expensive."
                        )
                        .addNpcChat("Port Master", 6999,
                                "Occasionally we will receive a special voyage",
                                "that will offer us an opportunity for unique rewards",
                                "or experience."
                        )
                        .addNpcChat("Port Master", 6999,
                                "I will find new voyages for you to take",
                                "once every day. If you ever run out of voyages",
                                "give me a day and I will find more for you."
                        )
                        .addNpcChat("Port Master", 6999,
                                "There's really so much to say about Sailing",
                                "but the best way to learn is by doing. Talk to",
